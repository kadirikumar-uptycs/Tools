...
def remove_tags(credentials, host_tag_dict:dict):
    ...
    for asset_id, tags_to_be_removed in host_tag_dict.items():
        ...
        print(colorama.Fore.LIGHTBLUE_EX + f"\n({index}) Host Name --> {colorama.Fore.YELLOW + f" {host_name} "}", end='')
        print(colorama.Fore.LIGHTBLUE_EX + f" Asset Id --> {colorama.Fore.YELLOW + f" {asset_id} "}")
        print(colorama.Fore.LIGHTGREEN_EX + f"\n\t→ Found {len(asset_tags)} tags in the Asset")
        print(colorama.Fore.LIGHTCYAN_EX + f"\n\t→ Tags to be removed: {colorama.Fore.LIGHTWHITE_EX + f" {tags_to_be_removed} "}")
...
def main():
    ...
    print(colorama.Fore.LIGHTYELLOW_EX + f"\tCredentials File: {colorama.Fore.LIGHTWHITE_EX + f'{credentials_path}'}")
    print(colorama.Fore.LIGHTYELLOW_EX + f"\tCSV File: {colorama.Fore.LIGHTWHITE_EX + f'{csv_path}'}")
    wait_a_second()
